...
function storage(item, prop) {
    ...
    ButtonFilms === null || ButtonFilms === void 0 ? void 0 : ButtonFilms.addEventListener('click', filter);
    ButtonGames === null || ButtonGames === void 0 ? void 0 : ButtonGames.addEventListener('click', filter);
    ButtonBouth === null || ButtonBouth === void 0 ? void 0 : ButtonBouth.addEventListener('click', filter);
